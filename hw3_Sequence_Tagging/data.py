...
def preprocesses(data):
    ...
    for fname in os.listdir(data_dir):
        ...
        feature_map[fname] = set(line.strip() for line in open(fname_))
    words = set()
    for l in data:
        for word in l:
            words.add(word)
    ...
    for feature in feature_map:
        count_map[feature] = list()
        for word in words:
            if word in feature_map[feature]:
                count_map[feature].append(word)

    for feature in count_map:
        print feature
        print len(count_map[feature])
